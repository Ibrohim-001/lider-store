...
function CarouselNavigation({
  ...
  return (
    <div
      className={cn(
        `pointer-events-none absolute ${left} top-1/2 flex ${width} -translate-y-1/2 justify-between px-2`,
        className
      )}
    >
      <button
        ...
        className={cn(
          'border-[.3px] border-primary pointer-events-auto h-fit w-fit rounded-full p-2 transition-opacity duration-300',
          alwaysShow
            ? 'opacity-100'
